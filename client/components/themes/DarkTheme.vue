...
:root {
  ...
  --surface-card: #1c1d26;
  --surface-overlay: #1c1d26;
  --surface-border: #2e303d;
  --surface-hover: rgba(255, 255, 255, 0.03);
  --focus-ring: 0 0 0 1px var(--primary-600);
  --maskbg: rgba(0, 0, 0, 0.4);
  --highlight-bg: rgba(177, 157, 247, 0.16);
  --highlight-text-color: var(--primary-500);
  color-scheme: dark;
}
* {
...
.p-datatable .p-sortable-column:focus {
  box-shadow: inset 0 0 0 0.15rem var(--primary-600);
  outline: 0 none;
}
...
.p-datatable .p-datatable-tbody > tr:focus {
  outline: 0.15rem solid var(--primary-600);
...
.p-tabview .p-tabview-nav li .p-tabview-nav-link {
  border: solid #2e303d;
  border-width: 0 0 2px 0;
  border-color: transparent transparent #2e303d transparent;
  background: #1c1d26;
  color: #b3b3b3;
  padding: 1.25rem;
  font-weight: 700;
...
.p-confirm-popup:before {
  ...
  border-bottom-color: #2e303d;
}
.p-confirm-popup.p-confirm-popup-flipped:after {
  border-top-color: #1c1d26;
}
.p-confirm-popup.p-confirm-popup-flipped:before {
  border-top-color: #2e303d;
}
...
.p-tooltip.p-tooltip-right .p-tooltip-arrow {
  border-right-color: #2e303d;
}
.p-tooltip.p-tooltip-left .p-tooltip-arrow {
  border-left-color: #2e303d;
}
