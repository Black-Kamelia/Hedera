...
import com.kamelia.jellyfish.rest.setting.UserSettings
import com.kamelia.jellyfish.rest.setting.UserSettingsTable
...
class User(id: EntityID<UUID>) : AuditableUUIDEntity(id, Users) {
    ...
    suspend fun getSettings(): UserSettings = Connection.query {
        settings.first()
    }
}
