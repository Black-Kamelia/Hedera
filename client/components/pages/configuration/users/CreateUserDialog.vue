...
const schema = object({
  ...
  password: string()
    ...
    .min(CREATE_USER_FORM.username.min, t('forms.create_user.errors.password_too_short', { min: CREATE_USER_FORM.username.min }))
    .max(CREATE_USER_FORM.username.max, t('forms.create_user.errors.password_too_long', { max: CREATE_USER_FORM.username.max })),
