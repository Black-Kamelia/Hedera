...
<head>
    ...
    <style type="text/css">@font-face {
        ...
        @font-face {
            ...
            font-weight: 400;
            font-display: swap;
            src: url(https://fonts.gstatic.com/s/redhattext/v14/RrQCbohi_ic6B3yVSzGBrMx6ZI_cy1A6Ok2ML7hwVrY.ttf) format('truetype');
        }
    </style>
    <style type="text/css">
        :root {
    ...
    <style type="text/css">
        ...
        body, h1, h2, h3, h4, h5, h6, hr, p, pre {
            margin: 0;
        }
        ...
        body, p, span, tr, td, table {
            font-family: 'Red Hat Text', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji;
        }
                        ...
                        <table style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", sans-serif; Margin:0 auto; width:456px; background-color:white; color:#043d75; font-size:16px; line-height:1.5; padding:16px'
                            ...
                            <tr align="center"
                                ...
                                <td align="center"
                                    ...
                                    <table cellpadding="0" cellspacing="0"
                                           style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji'>
                                        <tr style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji; height:16px'
                                            height="16"></tr>
                                        <tr style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji'>
                                            <td style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji'>
                                            ...
                                            <td style='box-sizing:border-box; position:relative; font-family:"Red Hat Text", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji'>
                                                <h1 style='Margin:0; font-family:"Red Hat Display", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji; font-size:2.5em; font-weight:500'>
                                                    Hedera</h1></td>
                                        </tr>
                                    </table>
                                </td>
