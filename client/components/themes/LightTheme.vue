...
:root {
  ...
  --focus-ring: 0 0 0 1px #917af5;
  --maskbg: rgba(0, 0, 0, 0.4);
  --highlight-bg: #e2dcfc;
  --highlight-text-color: #7d68df;
  color-scheme: light;
}
* {
...
.p-datepicker {
  padding: 0.5rem;
  background: linear-gradient(90deg, var(--primary-500) 0%, #9e68df 100%);
  color: #fff;
  border: 0 none;
  border-radius: 8px;
}
...
.p-button.p-button-outlined:enabled:hover {
  background: rgba(125, 104, 223, 0.04);
  color: var(--primary-500);
  border: 1px solid;
}
.p-button.p-button-outlined:enabled:active {
  background: rgba(125, 104, 223, 0.16);
  color: var(--primary-500);
  border: 1px solid;
}
...
.p-button.p-button-link:enabled:focus {
  background: transparent;
  box-shadow: 0 0 0 0.2rem #917af5;
  border-color: transparent;
}
...
.p-datatable .p-sortable-column:focus {
  box-shadow: inset 0 0 0 0.15rem #917af5;
  outline: 0 none;
}
