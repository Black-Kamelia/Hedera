...
// fun String.asMessage(parameters: Map<String, MessageKeyDTO>? = null) =
//     MessageKeyDTO(this, parameters)
fun String.asMessage(parameters: Map<String, String>? = null) =
    MessageKeyDTO(this, parameters?.mapValues { MessageKeyDTO(it.value) })
// fun String.asMessage(vararg parameters: Pair<String, MessageKeyDTO>) =
//     MessageKeyDTO(this, mapOf(*parameters))
